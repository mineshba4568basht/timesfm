...
> **Personal note:** I'm using this fork to experiment with TimesFM 2.5 on energy demand forecasting datasets. The XReg covariate support added in Oct. 2025 is particularly useful for my use case.
